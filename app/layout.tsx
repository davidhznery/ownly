...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.SITE_URL ?? 'https://clear-yield-malta.david-hernande64625.chatgpt.site'),
  title: 'Ownly — Know what your property is really earning',
