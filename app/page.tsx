  ...
  return (
    <main>
      ...
      <section className="hero wrap" id="top">
        <div className="hero-copy"><div className="pill"><i /> For property owners and subletters in Malta</div><h1>Know what your property is <em>really</em> earning.</h1><p>Track income, expenses, mortgages, cash flow and long-term returns in one clear dashboard.</p><div className="hero-actions"><a className="button" href="#pricing">Explore plans <Arrow /></a><button className="text-link video-trigger" type="button" onClick={()=>setVideoOpen(true)}><span>▶</span> See how it works</button></div><small className="reassurance">Made for Malta · Clear property finances · Simple monthly plans</small></div>
      ...
      <section className="section pricing-section" id="pricing"><div className="section-head"><span className="kicker">SIMPLE PRICING</span><h2>One property or a growing portfolio.</h2><p>Two simple plans. Two monthly plans. Secure 7-day trials open when Stripe setup is complete.</p></div><div className="pricing-grid wrap">
        <article><span className="plan">INDIVIDUAL</span><h3>€9<span>/month</span></h3><p>For owners and subletters managing one to three properties.</p><ul><li>Up to 3 properties</li><li>Income and expense tracking</li><li>Cash-flow dashboard</li><li>Long-term projections</li></ul><a className="outline-button" href="/register?plan=individual">Registration opening soon</a></article>
        <article className="popular"><div className="popular-label">MOST POPULAR</div><span className="plan">PORTFOLIO</span><h3>€25<span>/month</span></h3><p>For investors and managers with a growing portfolio.</p><ul><li>Up to 15 properties</li><li>Everything in Individual</li><li>Portfolio-level dashboard</li><li>Priority support</li></ul><a className="button" href="/register?plan=portfolio">Start 7-day free trial <Arrow /></a></article>
      ...
      <footer><div className="wrap footer-main"><div><Brand href="#top" /><p>Property performance, made clear.</p></div><div><b>Product</b><a href="#product">Features</a><a href="#pricing">Pricing</a><a href="/login?next=%2Fdashboard">Log in</a></div><div><b>Company</b><a href="mailto:hello@clearyield.app">Contact</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a></div></div><div className="wrap footer-bottom"><span>© 2026 Ownly Malta. All rights reserved.</span><span>Made for property owners and subletters in Malta 🇲🇹</span></div></footer>
